...
In Java, just include the com.decathlon.ara-lib library. +
...
See the
link:../../../lib/src/main/java/com/decathlon/com.decathlon.ara/lib/embed/producer/StructuredEmbedding.java[StructuredEmbedding's doc]
...
* link:../../../lib/src/main/java/com/decathlon/com.decathlon.ara/lib/embed/producer/StructuredEmbeddingsBuilder.java[StructuredEmbeddingsBuilder]
  to produce embedding data
* link:../../../lib/src/main/java/com/decathlon/com.decathlon.ara/lib/embed/consumer/StructuredEmbeddingsExtractor.java[StructuredEmbeddingsExtractor]
